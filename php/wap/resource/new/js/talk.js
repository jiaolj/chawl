...
var conn = new Easemob.im.Connection(),
	_id = Base.tools.getQueryString('id'),
	_nickname = Base.tools.getQueryString('nickname'),
	_headimgurl = Base.tools.getQueryString('headimgurl'),
	_user_id = null,
	_dom = {
		...
		other : '\
			<div class="list-item clearfix other">\
                <div class="user-image fl" style="background: url(#headimgurl) 50% 50% no-repeat;"></div>\
		...
		my : '\
            <div class="list-item clearfix self">\
                <div class="user-image fr" style="background: url(#headimgurl) 50% 50% no-repeat;"></div>\
