<header>		
	<section id="top_bar" style="text-align:center;height:47px;padding:5px 0px 0px 10px;">				
		<ul style="padding-top:5px;">
			...
			<li style="width:56%;vertical-align:30%;"><span class='header_title_text'>我收到的名片</span></li>
...
<content>
	...
	<section style="text-align:center;" class="goods_list_item">
		<ul>
			<li style="width:auto;vertical-align:top;text-align:left;position:relative;">
				...
				<div>
					<span style='font-size:14px;margin:0;padding:5px 0;font-weight:bold;color:#ed6d00;'><label><input type='checkbox' name='cid[]' class='cid' value='<?php echo $v['id']?>'/>删除名片</label></span>
				</div>
				<?php if($v['isMember']>0){ ?>
   ...
   <?php } ?>
	...
	<section style='background:#fff;height:200px;'>
    	<div style='padding:20px;'>没有收到相关名片信息!</div>
    </section>
	<?php }?>
...
$(".delete-btu").click(function(){
    var url = '<?php echo site_url('uc/deletecard') ?>';
    submit_form(url);
